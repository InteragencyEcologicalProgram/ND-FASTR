...
all.flip <- spread(data=zoop_NDFA_NMDS, key = Organism, value= CPUEZoop)
...
nmds <- metaMDS(m.ZoopCPUE, distance = "bray")
...
data.scores$StationCode = all.flip$StationCode
data.scores$Date = all.flip$Date

#plot
ggplot(data.scores, aes(x=NMDS1, y=NMDS2)) +
  geom_point(size=5, aes(shape=StationCode, colour=))
