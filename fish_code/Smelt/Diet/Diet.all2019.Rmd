...
setwd("C:/Users/nkwan/OneDrive - California Department of Water Resources/Projects/North Delta Flow Action Project/NDFA Synthesis/Smelt/Diet")
```
# bring in contractor (UW) data
```{r}
diet2 <- read.csv("DSM Cage Diets 2019-2020.csv", stringsAsFactors = F, na.strings=c("",NA)) #new data, not edited at all
...
```{r}
#prep------------------------------------------------------------------------
zoop <- read.csv("zoop_NDFA.csv", stringsAsFactors = F) #from lower trophic sub-team
...
plot(nmds)
PlotNMDS(nmds, data=full.flip, group = "site", group2 = "month")
