...
Tow_all2 <- filter(Tow_all, sumCPUE<3)
ggplot(Tow_all2, aes(x = Region, y = sumCPUE)) + geom_col(aes(fill = ActionPhase), position = "dodge2") + scale_fill_viridis(discrete = TRUE, option = "viridis") + theme_bw()

ggplot(Tow_all2, aes(x = ActionPhase, y = sumCPUE)) + geom_col(aes(fill = Region)) + scale_fill_viridis(discrete = TRUE, option = "viridis") + theme_bw()
