...
Jim Orlando from the USGS provided all of the contaminants data for water, suspended sediment, and zooplankton concentrations for 2015-2019. However the dataset did not include Method Detection Limits (MDL) for each parameter. As a result, we downloaded the contaminants data from the [USGS NWIS website](https://nwis.waterdata.usgs.gov/usa/nwis/qwdata) which contained this information. Only water and suspended sediment concentration data for 2015-2018 were available at the time. Therefore we used the water and suspended sediment data downloaded from NWIS and the zooplankton data provided by Jim Orlando. 
