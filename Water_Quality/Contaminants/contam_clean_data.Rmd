...
# Import water concentration data for 2015-2018:
  ...
  # Remove the contaminant concentration data on suspended sediment for 2015-2018 from nwis_orig and save it to work on later
  nwis_ss <- nwis_orig %>% filter(medium_cd == "SS")
  
  # Keep just the water concentration data for 2015-2018
...
* Parsing the startDateTime variable to a datetime object
* Converting the numeric parameter codes to the descriptive parameter names
* Creating a new variable to identify values above and below the Method Detection Limit (MDL)
* Make the result_va variable equal its MDL value for the samples below the MDL
