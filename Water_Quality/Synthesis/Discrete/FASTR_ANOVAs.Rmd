...
Current output is ANOVA results, aka, if the variable is significant. To fill out hypothesis table, need to do post-hoc analysis determine in what way it's significant (eg., for before/during/after, determine if the regression coefficents are positive/negative and determine which ones are "indivdually" significant).
...
for (i in seq(analytes)){
  ...
  df_aov$Variable <- row.names(df_aov)
