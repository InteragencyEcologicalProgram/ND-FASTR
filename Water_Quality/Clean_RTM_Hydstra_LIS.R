# NDFA Water Quality
# Purpose: Code to import, clean, and export LIS continuous water quality data
...
lis_all_clean %>% 
  write_excel_csv(
    path = paste0(sharepoint_path, "/Processed_Data/Continuous/RTM_OUTPUT_LIS_formatted.csv"),
    na = ""
  )
