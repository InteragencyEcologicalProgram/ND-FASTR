...
remove <- c('SRH', 'SHR', 'SRV', 'WWT', 'DWT', 'SDI')
...
for (i in seq(analytes)){
  ...
  lmer_emm <- emmeans(lmer_rg, specs = pairwise ~ FlowActionPeriod:FlowActionPeriod, adjust = 'tukey') # manually change the pairs cause I'm lazy
...
write_csv(all_reg_data, ndfa_abs_sp_path('WQ_Subteam/Analysis_Results/CWQ/no_SDI/cwq_emmeans_noSDI.csv'))
write_csv(all_aov_data, ndfa_abs_sp_path('WQ_Subteam/Analysis_Results/CWQ/no_SDI/cwq_aov_noSDI.csv'))
```
