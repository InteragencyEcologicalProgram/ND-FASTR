...
# Prepare data - All years of pH
rtm_clean_pH <- rtm_orig %>% 
  ...
  select(StationCode, DateTime, pH)

# Define flow action duration for 2013
rtm_clean_pH_2013 <- rtm_clean_pH %>%
...
ggsave("pH_2013.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2014
rtm_clean_pH_2014 <- rtm_clean_pH %>%
...
ggsave("pH_2014.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2015
rtm_clean_pH_2015 <- rtm_clean_pH %>%
...
ggsave("pH_2015.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2016
rtm_clean_pH_2016 <- rtm_clean_pH %>%
...
ggsave("pH_2016.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2017
rtm_clean_pH_2017 <- rtm_clean_pH %>%
...
ggsave("pH_2017.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2018
rtm_clean_pH_2018 <- rtm_clean_pH %>%
...
ggsave("pH_2018.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2019
rtm_clean_pH_2019 <- rtm_clean_pH %>%
...
ggsave("pH_2019.jpg", width = 7, height = 9.5, units = "in", dpi = 300)
