# NDFA Water Quality - Continuous Turbidity
...
# Prepare data - 2013 Turbidity
rtm_clean_turb <- rtm_orig %>% 
...
rtm_clean_turb_2013 <- rtm_clean_turb %>%
...
ggsave("Turb_2013.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2014
rtm_clean_turb_2014 <- rtm_clean_turb %>%
...
ggsave("Turb_2014.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2015
rtm_clean_turb_2015 <- rtm_clean_turb %>%
...
ggsave("Turb_2015.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2016
rtm_clean_turb_2016 <- rtm_clean_turb %>%
...
ggsave("Turb_2016.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2017
rtm_clean_turb_2017 <- rtm_clean_turb %>%
...
ggsave("Turb_2017.jpg", width = 7, height = 9.5, units = "in", dpi = 300)
# Define flow action duration for 2018
rtm_clean_turb_2018 <- rtm_clean_turb %>%
...
ggsave("Turb_2018.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Define flow action duration for 2019
rtm_clean_turb_2019 <- rtm_clean_turb %>%
...
ggsave("Turb_2019.jpg", width = 7, height = 9.5, units = "in", dpi = 300)
