...
# Prepare data - All years Chlorophyll
rtm_clean_chla <- rtm_orig %>% 
...
rtm_clean_chla_2013 <- rtm_clean_chla %>%
...
rtm_clean_chla_2014 <- rtm_clean_chla %>%
...
rtm_clean_chla_2015 <- rtm_clean_chla %>%
...
rtm_clean_chla_2016 <- rtm_clean_chla %>%
...
rtm_clean_chla_2017 <- rtm_clean_chla %>%
...
rtm_clean_chla_2018 <- rtm_clean_chla %>%
...
rtm_clean_chla_2019 <- rtm_clean_chla %>%
