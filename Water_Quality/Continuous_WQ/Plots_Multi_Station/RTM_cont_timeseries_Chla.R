# NDFA Water Quality - Continuous Chlorophyll
...
# Prepare data - 2013 Chlorophyll
rtm_clean_chla_2013 <- rtm_orig %>% 
  ...
  select(StationCode, DateTime, Chla)
...
# Prepare data - 2014 Chlorophyll
rtm_clean_chla_2014 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2014,
    !is.na(Chla)
...
ggsave("Chla_2014.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Prepare data - 2015 Chlorophyll
rtm_clean_chla_2015 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2015,
    !is.na(Chla)
...
ggsave("Chla_2015.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Prepare data - 2016 Chlorophyll
rtm_clean_chla_2016 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2016,
    !is.na(Chla)
...
ggsave("Chla_2016.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Prepare data - 2017 Chlorophyll
rtm_clean_chla_2017 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2017,
    !is.na(Chla)
...
ggsave("Chla_2017.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Prepare data - 2018 Chlorophyll
rtm_clean_chla_2018 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2018,
    !is.na(Chla)
...
ggsave("Chla_2018.jpg", width = 7, height = 9.5, units = "in", dpi = 300)

# Prepare data - 2019 Chlorophyll
rtm_clean_chla_2019 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2019,
    !is.na(Chla)
...
ggsave("Chla_2019.jpg", width = 7, height = 9.5, units = "in", dpi = 300)
