...
# Prepare data - 2014 Dissolved oxygen
rtm_clean_do_2014 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2014,
    !is.na(DO)
...
# Prepare data - 2015 Dissolved oxygen
rtm_clean_do_2015 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2015,
    !is.na(DO)
...
# Prepare data - 2016 Dissolved oxygen
rtm_clean_do_2016 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2016,
    !is.na(DO)
...
# Prepare data - 2017 Dissolved oxygen
rtm_clean_do_2017 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2017,
    !is.na(DO)
...
# Prepare data - 2018 Dissolved oxygen
rtm_clean_do_2018 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2018,
    !is.na(DO)
...
# Prepare data - 2019 Dissolved oxygen
rtm_clean_do_2019 <- rtm_orig %>% 
  mutate(DateTime = ymd_hms(DateTime)) %>% 
  filter(
    year(DateTime) == 2019,
    !is.na(DO)
