...
```{r print chla do fdom and flow plots, include = FALSE}
# Create a list of plot templates to use for Chla, DO, fDOM, and flow plots
produce_plots_chla_do_fdom_flow <- list(
...
`r knit(text = unlist(produce_plots_chla_do_fdom_flow))`
...
```{r print ph and spcnd plots, include = FALSE}
# Create a list of plot templates to use for fDOM and flow plots
produce_plots_ph_spcnd <- list(
...
`r knit(text = unlist(produce_plots_ph_spcnd))`
