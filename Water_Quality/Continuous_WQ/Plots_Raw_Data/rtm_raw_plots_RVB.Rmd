...
# Define relative file path for processed continuous WQ data file for RVB
fp_rel_rtm_data <- paste0(fp_fastr, "Processed_Data/Continuous/RTM_OUTPUT_RVB_formatted.csv")
...
```{r import data}
data_orig <- import_rtm_data(fp_abs_rtm_data, 8)
```
