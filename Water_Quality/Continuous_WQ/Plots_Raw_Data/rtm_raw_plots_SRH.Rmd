...
# Define relative file path for processed continuous WQ data file for SRH
fp_rel_rtm_data <- paste0(fp_fastr, "Processed_Data/Continuous/RTM_OUTPUT_SRH_formatted.csv")
