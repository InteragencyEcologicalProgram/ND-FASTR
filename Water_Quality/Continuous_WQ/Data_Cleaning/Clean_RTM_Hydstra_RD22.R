# NDFA Water Quality
# Purpose: Code to import, clean, and export RD22 continuous water quality data
...
# Import data
rd22_orig <- read_csv(
  file = paste0(sharepoint_path, "/Raw_Data/Continuous/RTM_RAW_DWR RD22_2013-2019.csv"),
  col_names = FALSE,
  skip = 3,
...
rd22_clean %>% 
  write_excel_csv(
    path = paste0(sharepoint_path, "/Processed_Data/Continuous/RTM_OUTPUT_RD22_formatted.csv"),
    na = ""
  )
