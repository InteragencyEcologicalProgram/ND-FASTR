---
title: "Check Outlier Detection Procedure - Turbidity"
...
rtm_wq_proc_clean <- rtm_wq_proc_orig %>% 
  ...
  select(DateTime, Year, StationCode, Turbidity) %>% 
...
```{r run outlier detect procedure turbidity}
  ...
  mutate(
    df_od = map(
      ...
      ~mutate(
        ...
        qual_spike = rtqc_spike(Turbidity, c(20, 40)),
