...
for (analyte in analytes){
  ...
  plt <- ggplot(df_filt, mapping = aes(BroadRegion, Result, fill=ActionPhase, outlier.color = ActionPhase)) +
    
    geom_violin(color = 'black', draw_quantiles = c(0.25, 0.5, 0.75), alpha = 0.65, size = 0.75) +
    ggtitle(analyte) + 
    blank_theme() +
    ...
    geom_violin(fill = 'transparent', size = 0.9, color = 'black')
