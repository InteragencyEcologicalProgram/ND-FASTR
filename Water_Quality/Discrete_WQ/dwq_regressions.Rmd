...
df_discrete <- ndfa_action_periods2(df_discrete, na_action_remove = TRUE, keep_action_dates = TRUE)
...
reg_func <- function(df, analyte_name){
  ...
  aov_lmer <- anova(lmer_fit, type = 'III') # look into type II -- better when you don't have interaction terms?
